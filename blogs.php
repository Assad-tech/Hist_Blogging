...
if ($result) {
  ...
  // print_r($post_data['category_title']);
  // }
...
?>
  ...
  <div class="container-fluid Main-blogger-details p-0">
    <nav class="navbar navbar-expand-lg navbar-light">
      ...
      <a class="navbar-brand" href="#"><img src="<?php echo $post_data['user_image'] ?>" alt="Blogger image">
        <h2 class="blogger-name"><?php echo $post_data['first_name'] ?></h2>
      </a>
      <!-- Follow button -->
      <?php
      if (isset($_SESSION['user'])) {
        ?>
        <button class="follow-btn"><i class="fa fa-rss" aria-hidden="true"></i> Follow</button>
        <?php
      } else {
        echo " ";
      }
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <div class=" blog-name">
          <h3><?php echo $post_data['blog_title'] ?></h3>
              ...
              <div class="col">
                <div class="collapse multi-collapse" id="multiCollapseExample1">
                  <div class="card card-body">
                    <!-- 1st comment -->
                    <?php
                    $select_comment = "SELECT * FROM user_post_comment upc INNER JOIN user u ON upc.user_id = u.user_id WHERE post_id='" . $post_data['post_id'] . "'";
                    ...
                    <table class="table table-borderless">
                      ...
                      ?>
                          <tr>
                            ...
                            <th class="w-25"><?= $comment['first_name'];
                                              echo " " . $comment['last_name'] ?></th>
