...
(24,91,'Business News',NULL,NULL,'active','2022-05-20 10:00:21','2022-05-24 09:55:14'),
(26,91,'Life Hacks and Tips (Life Hacking)',0,NULL,'active','2022-05-22 16:43:33','2022-05-24 09:55:19'),
(27,91,'Data Republic (IT)',0,NULL,'active','2022-05-22 16:47:34','2022-05-24 09:57:05');
...
(28,26,'Home Made Crafts','Jewellery. If you have the skills and creative passion, jewellery can be a great homemade product to sell.','Bath Bombs and Soaps. One of the easiest homemade items to make, bath bombs and soaps can be a great product to sell online.','uploaded_data/17873-post-post_img_5.jpg','active',0,'2022-05-24 10:50:26',NULL);
...
(18,28,'pdf file','uploaded_data/42361_1652935478_Assad Ali_profile.pdf','active','2022-05-24 10:50:26',NULL);
...
(26,28,6,'2022-05-24 10:50:26',NULL);
...
CREATE TABLE `user` (
  ...
  `is_approved` enum('pending','approved','rejected') DEFAULT 'approved',
  `is_active` enum('active','in-active') DEFAULT 'active',
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `updated_at` timestamp NULL DEFAULT NULL ON UPDATE current_timestamp(),
  PRIMARY KEY (`user_id`),
...
(1,94,24,'Unfollowed','2022-05-29 14:37:09','2022-05-29 15:00:45'),
(19,92,24,'Followed','2022-05-30 02:21:27',NULL),
(25,92,26,'Followed','2022-05-30 02:37:47',NULL),
(26,92,27,'Followed','2022-05-30 02:37:52',NULL);
...
(6,NULL,'Tagar Ali','tagar@gmail.com','This is Feedback Message testing 1','2022-05-29 00:33:09',NULL),
(7,NULL,'Zain','zain@gmail.com','Zain sending Feedback to admin testing','2022-05-29 00:35:29',NULL);
...
(18,22,92,'Comment on Atimic Habbit post','active','2022-05-24 11:40:50'),
(19,26,92,'Music Title post commented','active','2022-05-24 11:42:17'),
(20,28,94,'Apply for VU is online system..','active','2022-05-24 11:58:39'),
(21,20,94,'Comment on Business Title post','active','2022-05-24 12:00:21'),
(22,28,93,'Comment on Home made crafts..','active','2022-05-29 00:42:34'),
(23,23,93,'Stock Market High due to high petrol pricess','active','2022-05-29 01:02:14');
