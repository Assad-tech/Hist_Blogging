        ...
        <div class="card rounded-0 border-0 mt-3 mb-3">
            ...
            <form class="">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="7" placeholder="Your Message Here"></textarea>
                </div>
                <div class="form-check">
                </div>
                <button type="submit" class="activity-btns rounded-0 border-0">Submit</button>
            </form>
