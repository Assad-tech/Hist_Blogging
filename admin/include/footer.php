            ...
            <div class="card text-center">
                    <ul class="list-group ">
                        <li class="list-group-item bg-light ">
                            <a href="about-us.php?page=about-us"><i class="fa fa-address-card-o" aria-hidden="true"></i> About Us</a></li>
                        <li class="list-group-item bg-light ">
                            <a href="contact-us.php?page=contact-us"><i class="fa fa-fw fa-envelope"></i> Contact Us</a></li>
                        <li class="list-group-item bg-light">
                            <a href="#"><i class="fa fa-list-alt" aria-hidden="true"></i> Categories</a></li>
                    </ul>
                </div>
            </div>    
        <div class="col-lg-6 col-md-6">
